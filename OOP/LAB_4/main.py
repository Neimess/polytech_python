...
from math import sqrt, sin, radians, pi, cos
...
class Triangle(Shape):
    ...
    def __init__(self, a: Number, b: Number, c: Number):
        ...
        ValueError: If any side is less than 0 or if the sides do not form a valid triangle.
        """
        if not isinstance(a, Number) and isinstance(b, Number) and (c, Number):
